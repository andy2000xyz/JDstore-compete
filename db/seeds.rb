...
products = [{title:"Power BI 实战",
	        ...
	        image_path: "#{Rails.root}/public/images/datalab-3.png"},
					...
					{title:"Power BI 实战",
	        description: "用Power BI解决商业问题.",
	        image_path: "#{Rails.root}/public/images/datalab-4.png"},

					{title:"Power BI 实战",
	        description: "用Power BI解决商业问题.",
	        image_path: "#{Rails.root}/public/images/datalab-5.png"},

					{title:"Power BI 实战",
	        description: "用Power BI解决商业问题.",
	        image_path: "#{Rails.root}/public/images/datalab-6.png"}]
...
p4 = Product.create([title:products[3][:title],description:products[3][:description],quantity:999,price:199,image:open(products[3][:image_path])])
p5 = Product.create([title:products[4][:title],description:products[4][:description],quantity:999,price:199,image:open(products[4][:image_path])])
p6 = Product.create([title:products[5][:title],description:products[5][:description],quantity:999,price:199,image:open(products[5][:image_path])])
